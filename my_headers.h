...
void  undo1(int *score1, int *score2, int i,int stor[20],int stoc[20],int size,  int array2[size][size], int array1[size][size], int array[size][size], char active[size][size],int *ii);
